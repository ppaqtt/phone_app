...
import com.qingjian.notes.nav.NotesNavGraph
import com.qingjian.notes.ui.screens.AboutLegalScreen
import com.qingjian.notes.ui.screens.AppLockScreen
import com.qingjian.notes.ui.screens.PermissionIntroScreen
import com.qingjian.notes.ui.screens.SplashScreen
import com.qingjian.notes.ui.theme.NotesAppTheme
import com.qingjian.notes.ui.theme.ScreenOrientation
import com.qingjian.notes.ui.theme.rememberThemePreference
import com.qingjian.notes.ui.viewmodel.NotesViewModel
import com.qingjian.notes.ui.viewmodel.ViewModelFactory
import com.qingjian.notes.util.NotificationPermission
import com.qingjian.notes.util.PermissionIntroPrefs
import com.qingjian.notes.util.SecurityChecker
import com.qingjian.notes.util.UpdateAvailableDialog
import com.qingjian.notes.util.AppUpdateChecker
import com.qingjian.notes.util.rememberNotificationPermissionRequest
...
class MainActivity : AppCompatActivity() {
            ...
            NotesAppTheme {
                Surface(
                    ...
                    if (showLegal && pendingLegalUri != null) {
                        AboutLegalScreen(
                            title = "隐私政策",
                            rawResId = com.qingjian.notes.R.raw.privacy_policy,
    ...
    companion object {
        ...
        const val ACTION_NEW_NOTE = "com.qingjian.notes.action.NEW_NOTE"
        const val ACTION_OPEN_NOTE = "com.qingjian.notes.action.OPEN_NOTE"
...
fun AppLockGate(
    appLockStore: com.qingjian.notes.util.AppLockStore,
    ...
    if (locked) {
        com.qingjian.notes.ui.screens.AppLockScreen(
            store = appLockStore,
            mode = com.qingjian.notes.ui.screens.Mode.Unlock,
