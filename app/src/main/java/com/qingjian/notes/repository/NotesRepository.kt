package com.qingjian.notes.repository

import com.qingjian.notes.data.BacklinkScanStateDao
import com.qingjian.notes.data.BacklinkScanStateEntity
import com.qingjian.notes.data.CategoryDao
import com.qingjian.notes.data.CategoryEntity
import com.qingjian.notes.data.NoteAttachmentDao
import com.qingjian.notes.data.NoteAttachmentEntity
import com.qingjian.notes.data.NoteBacklinkDao
import com.qingjian.notes.data.NoteBacklinkEntity
import com.qingjian.notes.data.NoteChangeLogDao
import com.qingjian.notes.data.NoteChangeLogEntity
import com.qingjian.notes.data.NoteCharCountRow
import com.qingjian.notes.data.NoteCommentDao
import com.qingjian.notes.data.NoteCommentEntity
import com.qingjian.notes.data.NoteDao
import com.qingjian.notes.data.NoteEntity
import com.qingjian.notes.data.NoteIdTitleContentTags
import com.qingjian.notes.data.NoteImageDao
import com.qingjian.notes.data.NoteImageEntity
import com.qingjian.notes.data.NoteStatsRow
import com.qingjian.notes.data.NoteWithCategory
import com.qingjian.notes.data.NoteWithCategoryAndImages
import com.qingjian.notes.data.SearchHistoryDao
import com.qingjian.notes.data.SearchHistoryEntity
import com.qingjian.notes.data.SyncConfigDao
import com.qingjian.notes.data.SyncConfigEntity
import com.qingjian.notes.data.TagGroupDao
import com.qingjian.notes.data.TagGroupEntity
import com.qingjian.notes.data.TagGroupTagEntity
import com.qingjian.notes.data.UserNoteTemplateDao
import com.qingjian.notes.data.UserNoteTemplateEntity
...
class NotesRepository(
    ...
    private val noteVersionDao: com.qingjian.notes.data.NoteVersionDao,
    private val noteEncryptionDao: com.qingjian.notes.data.NoteEncryptionDao,
    ...
    suspend fun exportBackup(appVersion: String): BackupPayload {
        return database.withTransaction {
            ...
            com.qingjian.notes.util.BackupManager.buildPayload(
    ...
    suspend fun saveNoteVersion(noteId: Long, title: String, content: String) {
        noteVersionDao.insert(com.qingjian.notes.data.NoteVersionEntity(noteId = noteId, title = title, content = content))
        // 保留最近 20 个版本
    ...
    suspend fun setNoteEncrypted(noteId: Long, encryptedContent: String, salt: String) {
        noteEncryptionDao.upsert(
            com.qingjian.notes.data.NoteEncryptionEntity(
                noteId = noteId,
    ...
    suspend fun getCharCounts(): List<com.qingjian.notes.data.NoteCharCountRow> = noteDao.getCharCounts()
