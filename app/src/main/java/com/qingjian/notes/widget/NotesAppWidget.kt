package com.qingjian.notes.widget
...
import com.qingjian.notes.MainActivity
...
class NotesAppWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_REFRESH = "com.qingjian.notes.widget.ACTION_REFRESH"
...
class NotesRemoteViewsFactory(
    ...
    private var notes: List<com.qingjian.notes.data.NoteEntity> = emptyList()
